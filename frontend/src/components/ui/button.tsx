...
const buttonVariants = cva(
  // `transition-colors` em vez do `transition-all` original do shadcn —
  // `all` anima filter/backdrop-filter/transform sem necessidade e
  // causa flicker em browsers Chromium (Opera GX em dark mode). O
  // translate-y-px no :active mantém o feedback instantâneo do clique.
